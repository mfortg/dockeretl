...
def download_pokemon_image(pokemon_name: str, folder: str = None) -> None:
    try:
        ...
        #Creamos la carpeta "Equipo Ganador" en el escritorio
        desktop_path = Path.home() / "Desktop"
        folder = desktop_path / "Equipo Ganador"
        os.makedirs(folder, exist_ok=True) #exist_ok hace que no salte error si el directorio ya existe
